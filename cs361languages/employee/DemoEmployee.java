...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		// TODO To complete
		// emp3.whoAmI() // prints ... because ... It is defined in Employee.java and emp3 is a class of Employee
		// emp3.getHourlyRate(); // returns syntax error because ... Function does not exist in class of Employee
		...
		// because ... For some reason it does not return a ClassCastException 
